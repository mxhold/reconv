...
var unit_definitions = [{ "unit": "c", "mL": 237 }];
...
it('uses default unit data if none specified', () => {
  var ingredient = {
    quantity: "1/2",
    unit: "c",
    name: "malk",
  };
  var ingredient_definitions = [{ "name": "malk", "density": 1.032903803 }];

  expect(convertIngredient(ingredient, ingredient_definitions)).toEqual(
    {
      success: true,
      result: {
        quantity: "122",
